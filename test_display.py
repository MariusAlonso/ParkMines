...
class TestTest():
    ...
    def test_zero_minus_algorithm(self):
        ...
        #with open("log.txt", "w") as log_file:
        #    sys.stdout = log_file
        Display(datetime.datetime(2016,1,1,0,0,0,0), stock, [Robot(1), Robot(2), Robot(3)], real_parking, AlgorithmZeroMinus, 12, 20, print_in_terminal=False)
