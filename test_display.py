...
class TestTest():
    ...
    def test_display_parking(self):
        ...
        Vehicle.next_id = 1
        stock = RandomStock(30, time = datetime.timedelta(days=150))
        ...
        with open("log.txt", "w") as log_file:
            # sys.stdout = log_file
            simulation = Simulation(datetime.datetime(2000,1,1,0,0,0,0), stock, [Robot(1), Robot(2)], real_parking, AlgorithmRandom, print_in_terminal = False)
    ...
    def test_unimodal_algorithm(self):
        ...
        with open("log.txt", "w") as log_file:
            # sys.stdout = log_file
            simulation = Simulation(datetime.datetime(2000,1,1,0,0,0,0), stock, [Robot(1), Robot(2)], real_parking, AlgorithmNewUnimodal, print_in_terminal = False)
            simulation.start_display(12, 20)
            simulation.display.run()
            print(simulation.display)
    ...
    def test_zero_minus_algorithm(self, optimization_parameters=(1., 1000., 100., -10., 0.7, 2)):
        ...
        #with open("log.txt", "w") as log_file:
        #    sys.stdout = log_file
        simulation = Simulation(datetime.datetime(2000,1,1,0,0,0,0), stock, [Robot(1), Robot(2)], real_parking, AlgorithmZeroMinus, print_in_terminal = False, optimization_parameters = optimization_parameters)
        simulation.start_display(12, 20)
        simulation.display.run()
        print(simulation.display)
...
test.test_zero_minus_algorithm()