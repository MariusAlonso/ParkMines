...
class TestTest():
    ...
    def test_display_parking(self):
        ...
        Vehicle.next_id = 1
        stock = RandomStock(5, time = datetime.timedelta(days=30))
        ...
        with open("log.txt", "w") as log_file:
            # sys.stdout = log_file
            simulation = Simulation(datetime.datetime(2000,1,1,0,0,0,0), stock, [Robot(1), Robot(2)], parking, AlgorithmRandom, print_in_terminal = True)
