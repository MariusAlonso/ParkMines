...
class TestTest():
    ...
    def test_display_parking(self):
        ...
        Vehicle.next_id = 1
        stock = RandomStock(40, time = datetime.timedelta(days=1000))
        ...
        with open("log.txt", "w") as log_file:
            sys.stdout = log_file
            display = Display(datetime.datetime(2016,1,1,0,0,0,0), stock, [Robot(1), Robot(2)], real_parking, AlgorithmUnimodal, 12, 20, print_in_terminal = False)
    ...
    def test_zero_minus_algorithm(self, optimization_parameters=(1., 3., 100., -10.)):
        ...
        #with open("log.txt", "w") as log_file:
        #    sys.stdout = log_file
        Display(datetime.datetime(2016,1,1,0,0,0,0), stock, [Robot(1), Robot(2), Robot(3)], real_parking, AlgorithmZeroMinus, 12, 20, print_in_terminal=False, optimization_parameters=optimization_parameters)
